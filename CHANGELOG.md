...
### [2026-04-05 21:20] 운영 효율성 시뮬레이션 모델 도입
- **모델별 스펙 데이터 추가**: OpenAI, BERT, Gemini, Qwen 모델의 **비용, 학습 난이도, 보안성** 수치 데이터를 시뮬레이션으로 도입.
- **운영 효율성 시각화**: 모델별 효율성을 전용 선형 차트와 상세 리포트 카드 내 수치 정보로 시각화하여 비즈니스 의사결정 참고 기능 추가.
- **현실성 있는 분석 가이드**: 각 모델의 장단점(예: BERT의 무상 운영 및 고보안 vs OpenAI의 고성능 및 유료 운영)을 종합 가이드에 반영.
